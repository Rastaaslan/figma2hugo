...
class HugoGeneratorTests(unittest.TestCase):
    ...
    def test_hugo_generator_page_shell_accounts_for_visible_content_bleed(self) -> None:
        ...
        self.assertIn("isResponsiveFixedLayout ? 0 : fallbackHeight", page_shell_js)
        self.assertIn("var pageHeight = isResponsiveFixedLayout", page_shell_js)
        self.assertIn(": Math.max(fallbackHeight, visibleBounds.height);", page_shell_js)
        ...
        self.assertIn("function repairReadableTinyForm(form, scale, width)", page_shell_js)
        self.assertIn('data-page-shell-readable-form", "true"', page_shell_js)
        self.assertIn("function repairReadableFormControlText(form, scale)", page_shell_js)
        self.assertIn("function stretchFormVisualBand(form, section, minHeight)", page_shell_js)
        self.assertIn('data-page-shell-stretched-band="true"', page_shell_js)
        self.assertIn("function repairResponsiveTextSizeConsistency(page, scale)", page_shell_js)
        self.assertIn('data-page-shell-normalized-text="true"', page_shell_js)
        self.assertIn("function estimateNormalizedTextHeight(item, width, fontSize, lineHeight, scale)", page_shell_js)
        ...
        self.assertIn("function repairRescuedTrailingTexts(page, scale)", page_shell_js)
        self.assertIn("function repairAnchoredRescuedTexts(page, scale)", page_shell_js)
        self.assertIn("function ensureRescuedHeadingClearance(section, heading, rescuedText, scale)", page_shell_js)
        self.assertIn('data-page-shell-rescued-text="true"', page_shell_js)
        self.assertIn("data-page-shell-rescue-heading-text", page_shell_js)
        self.assertIn("function hasHiddenAncestor(element, boundary)", page_shell_js)
        self.assertIn("function findVisibleHeadingByText(headings, text)", page_shell_js)
        self.assertIn("function hasVisibleParagraphAfter(texts, target, scale)", page_shell_js)
